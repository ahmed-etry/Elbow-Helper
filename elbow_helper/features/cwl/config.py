...
THREAD_STICKY_BURIAL_MESSAGES = 3
THREAD_STICKY_REPOST_COOLDOWN_SECONDS = 120.0
THREAD_STICKY_BURIAL_SCAN_LIMIT = 25
THREAD_SNAPSHOT_MAX_AGE_SECONDS = 90.0
...
CLAN_NAME_TO_CODE = {name: code for code, name in CWL_CLAN_NAMES.items()}
