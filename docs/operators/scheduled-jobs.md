...
| Feature | Work and normal interval |
|---|---|
| Account links | Refresh configured clan membership about every 15 minutes. |
| Achievements | Run achievement and economy updates daily and refresh the raffle hub roughly once an hour. |
